...
"invalid","!1077239","richerjack","0x6fba1340acd896eddf39b84685d293627089c07b","0x0bdcc740100a6e737b303c56066ca8dd5559b8661b0389b8f193857eb5878156","30793495","1748376337","0","10001","0",,"0.11",,,"0","0","usdc"`;
		...
		it("should handle CSV data with only headers", async () => {
			const headerOnlyMvrCsv =
				'"fid","username","display_name","address","transaction_hash","block_number","timestamp","follower_count","sequence","following_count","verified_accounts","score","spam_label","spam_label_updated","rewards_score","rewards_cents","purchase_type"';
